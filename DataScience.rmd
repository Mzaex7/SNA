...
g_competitors <- simplify(g_competitors, remove.multiple = TRUE, edge.attr.comb = "first")
...
legend("topright", legend = c("Direct Competitors", "Same Industry"), fill = c("red", "blue"))
```
