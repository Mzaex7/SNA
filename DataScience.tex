...
\subsubsection{Branchenzugehörigkeit}\label{branchenzugehuxf6rigkeit}
...
\CommentTok{\# Ausgabe der Unternehmen mit den höchsten Gehältern}
\NormalTok{top\_salaries }\OtherTok{\textless{}{-}} \FunctionTok{head}\NormalTok{(salary\_data, }\DecValTok{5}\NormalTok{)}

\FunctionTok{print}\NormalTok{(top\_salaries)}
\end{Highlighting}
\end{Shaded}
